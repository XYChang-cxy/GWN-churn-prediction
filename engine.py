...
class trainer():
    ...
    def __init__(self, scaler, in_dim, seq_length, num_nodes, nhid , dropout, lrate, wdecay, device, supports_len, gcn_bool, addaptadj, aptinit):
        self.model = gwnet(device, num_nodes, dropout, supports_len=supports_len, gcn_bool=gcn_bool, addaptadj=addaptadj, aptinit=aptinit, in_dim=in_dim, out_dim=seq_length, residual_channels=nhid, dilation_channels=nhid, skip_channels=nhid * 8, end_channels=nhid * 16)
    ...
    def train(self, input, supports, real_val):
        self.model.train()
    ...
    def eval(self, input,supports, real_val):
        self.model.eval()
